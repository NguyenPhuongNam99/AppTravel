  ...
  return (
    <ScrollView style={{flex: 1}}>
      <View style={styles.blockImageContainer}>
        ...
        <View style={styles.blockInfo}>
          <View style={styles.containInfo}>
            <Text style={styles.textInfo}>Tên khách sạn: {item.name}</Text>
      ...
      <View style={styles.containerClick}>
        <TouchableOpacity style={styles.blockClick} onPress={() => navigation.navigate('DetailRoom' as never, {item: item} as never)}>
